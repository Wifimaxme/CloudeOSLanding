      ...
      <div className="container mx-auto px-4 md:px-6">
        <ScrollReveal>
          ...
          <div className="mt-20 border-t border-white/10 pt-12">
              <h3 className="text-center text-2xl font-bold text-white mb-16">Этапы развития отношений</h3>
              <div className="grid md:grid-cols-3 gap-8 items-start relative">
                  
                  {/* Connecting Arrows for Desktop */}
                  <div className="hidden md:block absolute top-24 left-1/3 w-1/3 h-px border-t-2 border-dashed border-white/10 z-0"></div>
                  <div className="hidden md:block absolute top-24 left-2/3 w-1/3 h-px border-t-2 border-dashed border-white/10 z-0"></div>
