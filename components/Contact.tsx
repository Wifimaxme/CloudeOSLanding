          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                 <div className="flex items-center gap-3 p-4 bg-white/5 rounded-xl backdrop-blur-md border border-white/10 hover:bg-white/10 transition-colors shadow-lg shadow-black/20 hover:border-kvadra-purple/30">
            ...
            <div className="bg-[#111827]/80 backdrop-blur-xl rounded-3xl p-8 md:p-10 shadow-2xl text-white border border-white/10 relative overflow-hidden">
               ...
               {/* Decorative glow */}
               <div className="absolute -top-20 -right-20 w-64 h-64 bg-kvadra-purple/10 blur-[80px] rounded-full"></div>
              ...
              <form className="space-y-4 relative z-10" onSubmit={(e) => e.preventDefault()}>
                <div>
                  ...
                  <input type="text" className="w-full px-4 py-3 rounded-xl border border-white/10 bg-white/5 text-white focus:bg-white/10 focus:border-kvadra-purple focus:ring-1 focus:ring-kvadra-purple outline-none transition-all placeholder:text-slate-500" placeholder="Иван Иванов" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-slate-300 mb-1">Компания</label>
                  <input type="text" className="w-full px-4 py-3 rounded-xl border border-white/10 bg-white/5 text-white focus:bg-white/10 focus:border-kvadra-purple focus:ring-1 focus:ring-kvadra-purple outline-none transition-all placeholder:text-slate-500" placeholder="ООО Вектор" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-slate-300 mb-1">Email</label>
                  <input type="email" className="w-full px-4 py-3 rounded-xl border border-white/10 bg-white/5 text-white focus:bg-white/10 focus:border-kvadra-purple focus:ring-1 focus:ring-kvadra-purple outline-none transition-all placeholder:text-slate-500" placeholder="ivan@company.ru" />
                </div>
                <div className="pt-2">
